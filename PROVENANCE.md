...
Project identifier: `rw-master-system`
...
Release provenance is established with the public Git commit and tag, published artifact checksums, and retained license notices—not covert telemetry. The canonical version source is `skills/master-system-builder/VERSION`; platform manifests must match it.
